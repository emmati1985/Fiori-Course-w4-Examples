sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("mi first app with template/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("mi first app with template.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["mi first app with template/localService/mockserver"], function (mockserver) {
