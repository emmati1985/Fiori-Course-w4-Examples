sap.ui.define([
	...
	return BaseObject.extend("mi first app with template.model.GroupSortState", {
		 ...
		 * @alias mi first app with template.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CustomerName, or by GrossAmount
		 *
