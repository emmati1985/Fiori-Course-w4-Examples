sap.ui.define([
		...
		return BaseObject.extend("mi first app with template.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias mi first app with template.model.ListSelector
			 */
			 ...
			 * @return {mi first app with template.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
