sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/so/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("com.so.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/so/localService/mockserver"], function (mockserver) {
