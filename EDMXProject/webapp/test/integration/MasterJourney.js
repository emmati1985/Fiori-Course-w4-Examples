sap.ui.define([
		...
		opaTest("MasterList Filtering on NetAmount less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("NetAmount").
		...
		opaTest("MasterList Filtering on NetAmount more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 CurrencyCode").
				and.iPressOKInViewSelectionDialog();
