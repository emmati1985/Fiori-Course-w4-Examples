		...
		return BaseController.extend("com.so.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.so.view.ViewSettingsDialog", this);
